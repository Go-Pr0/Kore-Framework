---
name: team-lead
description: Orchestrates a native Claude Code agent team for workflow execution. Analyzes the task, dynamically assembles the right agents, drives the team to completion, and writes the final handoff.json.
tools:
model: sonnet
---
